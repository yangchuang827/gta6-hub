...
export const categories = [
  ...
  { slug: 'gameplay', name: '游戏玩法', color: 'vice-cyan' },
  { slug: 'characters', name: '角色介绍', color: 'vice-orange' },
  { slug: 'guides', name: '攻略指南', color: 'vice-pink' },
  { slug: 'rumors', name: '传闻与泄露', color: 'vice-purple' },
];
